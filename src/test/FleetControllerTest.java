...
public class FleetControllerTest {
	...
	public void testGetRent() {
		...
		player1.getProperty().addProperty(ship1);
		...
		player1.getProperty().addProperty(ship1);
		assertTrue("Fail, the rent should be 1500 with 3 fleet owned",ship1.getRent()==1500);
		player1.getProperty().addProperty(ship1);
		assertTrue("Fail, the rent should be 2000 with 4 fleet owned",ship1.getRent()==2000);
	}
}
